...
public class CheckPointTransformation2 {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 3) {
				...
				CheckPointTransformation2 runner = new CheckPointTransformation2();
				runner.loadModels(args[0], args[1]);
				runner.doCheckPointTransformation2(new NullProgressMonitor());
	...
	public CheckPointTransformation2() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("CheckPointTransformation2.properties").openStream());
	 ...
	 * @generated
	 */
	public Object doCheckPointTransformation2(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("CheckPointTransformation2.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("CheckPointTransformation2.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("CheckPointTransformation2.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("CheckPointTransformation2.options.")) {
				options.put(entry.getKey().toString().replaceFirst("CheckPointTransformation2.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = CheckPointTransformation2.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = CheckPointTransformation2.class.getResource(fileName);
		}
		if (fileURL == null) {
