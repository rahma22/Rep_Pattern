...
public class MyTransformation {
	...
	public MyTransformation() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("MyTransformation.properties").openStream());
	 ...
	 * @generated
	 */
	public Object doMyTransformation(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("MyTransformation.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("MyTransformation.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("MyTransformation.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("MyTransformation.options.")) {
				options.put(entry.getKey().toString().replaceFirst("MyTransformation.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = MyTransformation.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = MyTransformation.class.getResource(fileName);
		}
		if (fileURL == null) {
