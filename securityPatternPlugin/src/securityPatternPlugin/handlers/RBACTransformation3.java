...
public class RBACTransformation3 {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 3) {
				...
				runner3.loadModels(args[0], args[1]);
				runner3.doRBACTransformation3(new NullProgressMonitor());
				runner3.saveModels(args[2]);
			}
	...
	public RBACTransformation3() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("RBACTransformation3.properties").openStream());
	 ...
	 * @generated
	 */
	public Object doRBACTransformation3(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("RBACTransformation3.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("RBACTransformation3.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("RBACTransformation3.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("RBACTransformation3.options.")) {
				options.put(entry.getKey().toString().replaceFirst("RBACTransformation3.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = RBACTransformation3.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = RBACTransformation3.class.getResource(fileName);
		}
		if (fileURL == null) {
