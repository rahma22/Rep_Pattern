...
public class InitialTransformation {
	...
	public InitialTransformation() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("InitialTransformation.properties").openStream());
	 ...
	 * @generated
	 */
	public Object doInitialTransformation(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("InitialTransformation.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("InitialTransformation.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("InitialTransformation.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("InitialTransformation.options.")) {
				options.put(entry.getKey().toString().replaceFirst("InitialTransformation.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = InitialTransformation.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = InitialTransformation.class.getResource(fileName);
		}
		if (fileURL == null) {
