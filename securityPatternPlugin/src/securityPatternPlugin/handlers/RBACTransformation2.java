...
public class RBACTransformation2 {
	...
	public static void main(String[] args) {
		try {
			if (args.length < 3) {
				...
				RBACTransformation2 runner = new RBACTransformation2();
				runner.loadModels(args[0], args[1]);
				runner.doRBACTransformation2(new NullProgressMonitor());
	...
	public RBACTransformation2() throws IOException {
		properties = new Properties();
		properties.load(getFileURL("RBACTransformation2.properties").openStream());
	 ...
	 * @generated
	 */
	public Object doRBACTransformation2(IProgressMonitor monitor) throws ATLCoreException, IOException, ATLExecutionException {
	...
	protected InputStream[] getModulesList() throws IOException {
		...
		String modulesList = properties.getProperty("RBACTransformation2.modules");
		if (modulesList != null) {
	...
	protected String getMetamodelUri(String metamodelName) {
		return properties.getProperty("RBACTransformation2.metamodels." + metamodelName);
	}
	...
	protected InputStream getLibraryAsStream(String libraryName) throws IOException {
		return getFileURL(properties.getProperty("RBACTransformation2.libraries." + libraryName)).openStream();
	}
	...
	protected Map<String, Object> getOptions() {
		...
		for (Entry<Object, Object> entry : properties.entrySet()) {
			if (entry.getKey().toString().startsWith("RBACTransformation2.options.")) {
				options.put(entry.getKey().toString().replaceFirst("RBACTransformation2.options.", ""), 
	...
	protected static URL getFileURL(String fileName) throws IOException {
		final URL fileURL;
		if (isEclipseRunning()) {
			URL resourceURL = RBACTransformation2.class.getResource(fileName);
			if (resourceURL != null) {
			...
			fileURL = RBACTransformation2.class.getResource(fileName);
		}
		if (fileURL == null) {
